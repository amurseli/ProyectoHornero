...
public class ContributionStatusResponse {
    ...
    public ContributionStatusResponse(Long contributionId, Long campaignId, BigDecimal amount, String status, ContributionRewardInfo reward, TransactionInfo transaction) {
